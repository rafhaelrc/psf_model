...
public class Main {
	...
	public static void main(String[] args) throws OWLOntologyCreationException {
		...
		onto = new OwlOntoLayer("src/resources/initial_ontology_model_five_version.owl");
		...
		try {
	        ...
	        */
			...
			//OWLObjectProperty objectProperty = dataFactory.getOWLObjectProperty(IRI.create((String) ((Object) baseIRI + "#" + "isOwnerOf")));
			...
			for(OWLClass classe : classes) {
				System.out.println("Imprimindo nome das classes: " + classe.getIRI().getShortForm());
			}
